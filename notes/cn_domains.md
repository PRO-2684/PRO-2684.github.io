...
| 未知 | [中国原神大学.com](https://中国原神大学.com) | <span title='网站可能被盗用，也可能使用了 js 实现重定向'>🟡</span> | 🟢 |
...
- 本页面共收录 $42$ 个中文域名，其中 $21$ 个域名确认存活，$5$ 个域名暂时无法确认。
- 对所有网站发送 HTTP 请求，并得到响应/超时/报错：300.282076505 s
- 根据模板生成上述表格：372.936 μs
